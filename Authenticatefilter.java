...
public class Authenticatefilter implements Filter {
	...
	public Authenticatefilter(authService authService, userRepo userRepository) {
	...
	private void executeFilterLogic (ServletRequest request, ServletResponse response, FilterChain chain)
			...
			sendErrorResponse (httpResponse, HttpServletResponse.SC_UNAUTHORIZED, "Unauthorized: Invalid or missingtoken");
			return;
}	
...
private void sendErrorResponse(HttpServletResponse response, int statusCode, String message) throws IOException, java.io.IOException {
